...
// checkpoint-readiness-phase-1 (Task 5.3) — landing role selection store.
export { useRoleSelectionStore } from './roleSelectionStore';
export type { SelectedRole } from './roleSelectionStore';
