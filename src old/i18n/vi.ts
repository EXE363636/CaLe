...
export const vi: Record<string, string> = {
  ...
  // -------------------------------------------------------------------------
  // checkpoint-readiness-phase-1 (Task 5.5) — landing role separation +
  // industry focus. The landing splits into a worker view and an employer
  // view; only the chosen role's content shows (R1/R2). Pronoun discipline:
  // worker copy addresses the reader as "bạn"; employer copy speaks of
  // "nhà tuyển dụng"/"doanh nghiệp" and refers to hires as "người làm",
  // never "bạn" (R2.3–R2.6). Employer step 2 uses the soft payment wording
  // "Đảm bảo thanh toán" (R4). CTAs reuse EXISTING routes only (Task 5
  // decision): worker → /shifts, employer → /register?role=employer; the
  // survey CTA (/khao-sat) is deferred to Task 8.
  // -------------------------------------------------------------------------

  // Role switcher (neutral state)
  'landing.roleSwitcher.title': 'Bạn đến với CaLẻ với vai trò nào?',
  'landing.roleSwitcher.intro':
    'Chọn vai trò để xem nội dung phù hợp với nhu cầu của bạn.',
  'landing.roleSwitcher.worker': 'Tôi là người lao động',
  'landing.roleSwitcher.employer': 'Tôi là nhà tuyển dụng',
  'landing.roleSwitcher.switchHint': 'Bạn có thể đổi vai trò bất cứ lúc nào.',

  // Shared headings for the role view blocks (benefits / steps columns).
  // Kept pronoun-neutral so they're safe in BOTH worker and employer
  // views (employer copy must not address the reader as "bạn" — R2.5).
  'landing.benefits.heading': 'Lợi ích chính',
  'landing.steps.heading': 'Cách hoạt động',

  // Worker role view (addresses the reader as "bạn")
  'landing.role.worker.eyebrow': 'Dành cho người lao động',
  'landing.role.worker.title': 'Tìm ca làm linh hoạt, nhận lương minh bạch',
  'landing.role.worker.lead':
    'Bạn chọn ca phù hợp với lịch của mình, biết rõ giờ giấc và mức lương trước khi nhận.',
  'landing.role.worker.benefit1': 'Ca làm rõ ràng về giờ giấc, địa điểm và mức lương.',
  'landing.role.worker.benefit2': 'Bạn không phải trả trước bất kỳ khoản nào để nhận ca.',
  'landing.role.worker.benefit3':
    'Hoàn thành ca giúp bạn tích luỹ điểm uy tín và mở thêm cơ hội.',
  'landing.role.worker.step1.title': 'Tìm ca phù hợp',
  'landing.role.worker.step1.desc': 'Lọc ca theo khu vực, thời gian và mức lương phù hợp với bạn.',
  'landing.role.worker.step2.title': 'Ứng tuyển và check-in',
  'landing.role.worker.step2.desc': 'Ứng tuyển nhanh, đến ca và check-in đúng giờ.',
  'landing.role.worker.step3.title': 'Hoàn thành, nhận lương, tăng uy tín',
  'landing.role.worker.step3.desc':
    'Hoàn thành ca để nhận tiền công và nâng điểm uy tín của bạn.',
  'landing.role.worker.cta': 'Tìm ca làm ngay',

  // Employer role view (no "bạn"; uses "nhà tuyển dụng"/"người làm")
  'landing.role.employer.eyebrow': 'Dành cho nhà tuyển dụng',
  'landing.role.employer.title': 'Tuyển người làm ngắn hạn nhanh và an toàn',
  'landing.role.employer.lead':
    'Nhà tuyển dụng đăng ca, đảm bảo thanh toán và chọn người làm phù hợp một cách minh bạch.',
  'landing.role.employer.benefit1': 'Tiếp cận người làm linh hoạt theo nhu cầu từng ca.',
  'landing.role.employer.benefit2':
    'Khoản đảm bảo thanh toán giúp ca được công khai và tạo niềm tin với người làm.',
  'landing.role.employer.benefit3':
    'Điểm uy tín và lịch sử giúp doanh nghiệp chọn người làm đáng tin.',
  'landing.role.employer.step1.title': 'Đăng ca',
  'landing.role.employer.step1.desc': 'Tạo ca cần tuyển với mô tả, thời gian và mức lương rõ ràng.',
  'landing.role.employer.step2.title': 'Đảm bảo thanh toán',
  'landing.role.employer.step2.desc':
    'Hoàn tất khoản đảm bảo thanh toán để ca được công khai tới người làm.',
  'landing.role.employer.step3.title': 'Duyệt ứng viên và xác nhận hoàn thành',
  'landing.role.employer.step3.desc':
    'Chọn người làm phù hợp và xác nhận khi ca hoàn thành để giải ngân tiền công.',
  'landing.role.employer.cta': 'Đăng ca cần tuyển',

  // Industry focus (R11) — six focus industries, shown as deliberate focus.
  'landing.industry.eyebrow': 'Ngành trọng tâm',
  'landing.industry.title': 'CaLẻ tập trung vào một số ngành có nhu cầu ca ngắn hạn cao',
  'landing.industry.lead':
    'Chúng tôi tập trung vào các ngành dưới đây thay vì phục vụ mọi ngành, để hiểu sâu nhu cầu của từng bên.',
  'landing.industry.fnb': 'Nhà hàng / F&B',
  'landing.industry.cafe': 'Quán café',
  'landing.industry.events': 'Sự kiện',
  'landing.industry.weddings': 'Tiệc cưới',
  'landing.industry.retail': 'Bán lẻ',
  'landing.industry.logistics': 'Kho vận nhẹ',
};
