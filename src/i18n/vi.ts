...
export const vi: Record<string, string> = {
  ...
  'worker.dashboard.greeting': 'Xin chào, {name}',
  'common.employer': 'Nhà tuyển dụng',
  'wallet.worker.emptyHint': 'Tiền công được cộng vào ví khi ca của bạn được xác nhận hoàn thành.',
  'worker.dashboard.stats.upcoming': 'Ca sắp tới',
  'worker.dashboard.stats.upcomingAria': 'Xem các ca sắp tới',
  'worker.dashboard.stats.pending': 'Đơn chờ duyệt',
  'worker.dashboard.stats.pendingAria': 'Xem các đơn đang chờ nhà tuyển dụng duyệt',
  'worker.dashboard.pendingApplications': 'Đơn đang chờ duyệt',
  'worker.dashboard.noPendingApplications': 'Không có đơn nào đang chờ duyệt.',
  'worker.dashboard.findMore': 'Tìm ca làm →',
  ...
  'worker.dashboard.history.title': 'Đơn không thành',
  ...
  'review.summary.distribution': 'Phân bố số sao',
  ...
  'review.success': 'Đã gửi đánh giá. Cảm ơn bạn!',
  'review.status.given': 'Bạn chấm',
  'review.status.received': '{name} chấm bạn',
  'review.status.none': 'chưa đánh giá',
  'review.employer.prompt': 'Ca đã hoàn thành — bạn có 14 ngày để đánh giá người lao động.',
  'worker.postPaymentRating.banner.title.real': 'Ca đã hoàn thành. Bạn có 14 ngày để đánh giá nhà tuyển dụng (không bắt buộc).',
  'worker.profile.reviews.title': 'Đánh giá từ nhà tuyển dụng',
  'worker.profile.reviews.intro': 'Sau mỗi ca hoàn thành, nhà tuyển dụng có thể chấm sao và nhận xét về bạn. Nhà tuyển dụng khác xem được khi duyệt đơn.',
  'worker.profile.reviews.empty': 'Chưa có đánh giá nào. Đánh giá sẽ xuất hiện ở đây sau khi nhà tuyển dụng chấm ca bạn đã hoàn thành.',
  'worker.profile.reviews.count': '{n} đánh giá',
  'review.employer.open': 'Đánh giá người lao động',
  'review.employer.intro': 'Chấm sao và viết một câu nhận xét cho {name}. Người lao động và các nhà tuyển dụng khác sẽ thấy đánh giá này.',
  'review.employer.given': 'Bạn đã đánh giá {stars}/5 sao.',
  'review.error.NOT_COMPLETED': 'Chỉ đánh giá được sau khi ca đã xác nhận hoàn thành.',
  'review.error.ALREADY_SUBMITTED': 'Bạn đã đánh giá ca này rồi.',
  'review.error.REVIEW_WINDOW_CLOSED': 'Đã quá 14 ngày sau ca nên không thể đánh giá nữa.',
  'review.error.NOT_PARTICIPANT': 'Bạn không tham gia ca này nên không thể đánh giá.',
  'review.error.INVALID_STARS': 'Hãy chọn từ 1 đến 5 sao.',
  'review.error.COMMENT_TOO_LONG': 'Nhận xét tối đa 500 ký tự.',
  'review.error.SUSPENDED': 'Tài khoản đang bị tạm khoá nên không thể đánh giá.',
  'review.error.unavailable': 'Tính năng đánh giá chưa sẵn sàng. Vui lòng thử lại sau.',
  'review.error.generic': 'Không gửi được đánh giá. Vui lòng thử lại.',
  ...
  'auth.google.or': 'hoặc',
  'auth.google.error': 'Không mở được đăng nhập Google. Vui lòng thử lại.',
  'auth.oauth.complete.title': 'Hoàn tất đăng ký',
  'auth.oauth.complete.subtitle':
    'Bạn đã đăng nhập bằng Google. Chọn vai trò và bổ sung vài thông tin để bắt đầu.',
  'auth.oauth.complete.submit': 'Hoàn tất đăng ký',
  'auth.oauth.complete.cancel': 'Dùng tài khoản khác',
  'auth.oauth.complete.success': 'Đăng ký thành công',
  'auth.forgot.link': 'Quên mật khẩu?',
  'auth.forgot.title': 'Quên mật khẩu',
  'auth.forgot.subtitle': 'Nhập email đã đăng ký, chúng tôi sẽ gửi link đặt lại mật khẩu.',
  'auth.forgot.submit': 'Gửi link đặt lại',
  'auth.forgot.sent.title': 'Kiểm tra email của bạn',
  'auth.forgot.sent.body':
    'Nếu {email} đã đăng ký CaLẻ, bạn sẽ nhận được email có link đặt lại mật khẩu trong vài phút. Nhớ xem cả mục Thư rác / Quảng cáo.',
  ...
  'auth.reset.confirmPassword': 'Nhập lại mật khẩu mới',
  'auth.reset.mismatch': 'Hai mật khẩu không khớp.',
  'auth.reset.submit': 'Lưu mật khẩu mới',
  'auth.reset.success': 'Đã đổi mật khẩu',
  'auth.reset.invalidLink.title': 'Link không hợp lệ hoặc đã hết hạn',
  'auth.reset.invalidLink.body':
    'Link đặt lại mật khẩu chỉ dùng được một lần và có hạn. Hãy yêu cầu link mới.',
  'auth.reset.requestAgain': 'Gửi lại link',
  'auth.reset.error.same': 'Mật khẩu mới phải khác mật khẩu cũ.',
  'auth.reset.error.expired': 'Phiên đặt lại mật khẩu đã hết hạn. Hãy yêu cầu link mới.',
  ...
  'worker.profile.joinedSince': 'Tham gia CaLẻ từ {date}',
  'worker.profile.metric.completed': 'Ca hoàn thành',
  'worker.profile.metric.noShows': 'Vắng mặt',
  'worker.profile.metric.cancellations': 'Lần huỷ',
  'worker.profile.info.progress': 'Đã điền {n}/4 mục',
  'worker.profile.empty.lead':
    'Nhà tuyển dụng xem giới thiệu, kỹ năng và loại công việc ưa thích của bạn khi duyệt đơn. Điền vài dòng để họ hiểu bạn hơn.',
  'worker.profile.empty.cta': 'Điền hồ sơ',
  'worker.profile.prompt.bio.title': 'Giới thiệu bản thân',
  'worker.profile.prompt.bio.hint': 'Vài câu về kinh nghiệm và khung giờ bạn thường làm được.',
  'worker.profile.prompt.skills.title': 'Kỹ năng',
  'worker.profile.prompt.skills.hint': 'Ví dụ: phục vụ, pha chế, thu ngân, bưng bê sự kiện.',
  'worker.profile.prompt.jobTypes.title': 'Loại công việc ưa thích',
  'worker.profile.prompt.jobTypes.hint': 'Những việc bạn muốn nhận nhiều hơn.',
  'worker.profile.prompt.locations.title': 'Khu vực ưa thích',
  'worker.profile.prompt.locations.hint': 'Quận/huyện bạn tiện đi làm. Chỉ bạn thấy mục này.',
  'worker.profile.privateNote': 'Chỉ bạn thấy',
  'worker.profile.addMissing': 'Chưa có — bấm để thêm',
  ...
  'verify.id.collapsedHint': 'Cần ảnh 2 mặt CCCD và một ảnh chân dung cầm CCCD.',
  'verify.id.start': 'Bắt đầu xác thực CCCD',
  'verify.status.verified': 'Đã xác thực',
  'verify.status.notVerified': 'Chưa xác thực',
  'verify.status.pending': 'Đang chờ duyệt',
  'verify.status.rejected': 'Bị từ chối',
  'verify.required': 'Bắt buộc',
  'verify.phone.title': 'Số điện thoại',
  'verify.phone.label': 'Số điện thoại di động',
  'verify.phone.send': 'Gửi mã',
  'verify.phone.resend': 'Gửi lại mã',
  'verify.phone.resendIn': 'Gửi lại sau {seconds} giây',
  'verify.phone.change': 'Đổi số',
  'verify.phone.start': 'Xác thực ngay',
  'verify.phone.codeLabel': 'Mã 6 số',
  'verify.phone.codeSent': 'Đã gửi mã tới {phone}. Mã có hiệu lực 5 phút.',
  'verify.phone.codeSentMock':
    'Chế độ thử: không gửi SMS thật. Admin xem mã trong log Edge Function phone-otp.',
  'verify.phone.confirm': 'Xác nhận',
  'verify.phone.success': 'Đã xác thực số điện thoại',
  'verify.phone.changeWarning':
    'Đổi số điện thoại trong hồ sơ sẽ cần xác thực lại.',
  'verify.otp.error.OTP_COOLDOWN': 'Bạn vừa yêu cầu mã. Vui lòng đợi {seconds} giây rồi thử lại.',
  'verify.otp.error.OTP_USER_LIMIT': 'Bạn đã yêu cầu quá nhiều mã hôm nay. Vui lòng thử lại sau 24 giờ.',
  'verify.otp.error.OTP_PHONE_LIMIT': 'Số điện thoại này đã nhận quá nhiều mã hôm nay. Vui lòng thử lại sau 24 giờ.',
  'verify.otp.error.OTP_IP_LIMIT': 'Có quá nhiều yêu cầu từ mạng của bạn. Vui lòng thử lại sau.',
  'verify.otp.error.OTP_DAILY_CAP': 'Hệ thống tạm ngừng gửi mã do quá tải. Vui lòng thử lại sau.',
  'verify.otp.error.INVALID_PHONE': 'Số điện thoại di động Việt Nam không hợp lệ.',
  'verify.otp.error.PHONE_IN_USE': 'Số điện thoại này đã được xác thực bởi tài khoản khác.',
  'verify.otp.error.PHONE_ALREADY_VERIFIED': 'Số điện thoại này đã được xác thực.',
  'verify.otp.error.SMS_NOT_CONFIGURED': 'Tính năng gửi mã chưa sẵn sàng. Vui lòng thử lại sau.',
  'verify.otp.error.SMS_SEND_FAILED': 'Không gửi được tin nhắn. Vui lòng thử lại sau ít phút.',
  'verify.otp.error.OTP_INVALID': 'Mã không đúng.',
  'verify.otp.error.OTP_INVALID_LEFT': 'Mã không đúng. Còn {count} lần thử.',
  'verify.otp.error.OTP_EXPIRED': 'Mã đã hết hạn. Hãy yêu cầu mã mới.',
  'verify.otp.error.OTP_TOO_MANY_ATTEMPTS': 'Nhập sai quá nhiều lần. Hãy yêu cầu mã mới.',
  'verify.id.title': 'Căn cước công dân (CCCD)',
  'verify.id.intro':
    'Chụp rõ 2 mặt CCCD và một ảnh chân dung cầm CCCD. Ảnh chỉ quản trị viên CaLẻ xem được để đối chiếu, không hiển thị công khai.',
  'verify.id.fullName': 'Họ và tên (đúng như trên CCCD)',
  'verify.id.number': 'Số CCCD (12 số)',
  'verify.id.dob': 'Ngày sinh',
  'verify.id.front': 'Ảnh mặt trước',
  'verify.id.back': 'Ảnh mặt sau',
  'verify.id.selfie': 'Ảnh chân dung cầm CCCD',
  'verify.id.choose': 'Chọn / chụp ảnh',
  'verify.id.chosen': 'Đã chọn',
  'verify.id.consent':
    'Tôi đồng ý cho CaLẻ lưu và sử dụng ảnh CCCD này chỉ để xác minh danh tính.',
  'verify.id.submit': 'Gửi xác thực',
  'verify.id.submitted': 'Đã gửi CCCD. Quản trị viên sẽ duyệt trong thời gian sớm nhất.',
  'verify.id.pendingBody': 'CCCD của bạn đang chờ quản trị viên duyệt.',
  'verify.id.rejectedBody': 'CCCD bị từ chối: {reason}. Bạn có thể gửi lại.',
  'verify.id.approvedBody': 'Danh tính của bạn đã được xác thực.',
  'verify.id.error.missingImages': 'Vui lòng chọn đủ 3 ảnh.',
  'verify.id.error.consent': 'Vui lòng đồng ý điều khoản lưu ảnh để tiếp tục.',
  'verify.id.error.INVALID_ID_NUMBER': 'Số CCCD phải gồm đúng 12 chữ số.',
  'verify.id.error.INVALID_FULL_NAME': 'Vui lòng nhập họ tên như trên CCCD.',
  'verify.id.error.INVALID_DATE_OF_BIRTH': 'Ngày sinh không hợp lệ (phải đủ 15 tuổi).',
  'verify.id.error.INVALID_DOCUMENT': 'Ảnh tải lên không hợp lệ. Vui lòng chọn lại.',
  'verify.id.error.ID_NUMBER_IN_USE': 'Số CCCD này đã được xác thực cho tài khoản khác.',
  'verify.id.error.ALREADY_PENDING': 'Bạn đã gửi CCCD và đang chờ duyệt.',
  'verify.id.error.IDENTITY_ALREADY_VERIFIED': 'Danh tính của bạn đã được xác thực.',
  'verify.id.error.UPLOAD_FAILED': 'Tải ảnh lên thất bại (ảnh tối đa 5 MB). Vui lòng thử lại.',
  'verify.gate.phone.worker':
    'Bạn cần xác thực số điện thoại trước khi ứng tuyển.',
  'verify.gate.phone.employer':
    'Bạn cần xác thực số điện thoại trước khi đăng ca.',
  'verify.gate.identity':
    'Bạn cần xác thực CCCD (được quản trị viên duyệt) trước khi đăng ca.',
  'verify.gate.identityPending':
    'CCCD của bạn đang chờ duyệt. Bạn có thể đăng ca ngay khi được duyệt.',
  'verify.gate.cta': 'Xác thực trong Hồ sơ',
  'error.PHONE_NOT_VERIFIED': 'Bạn cần xác thực số điện thoại trong trang Hồ sơ trước.',
  'error.IDENTITY_NOT_VERIFIED': 'Bạn cần xác thực CCCD trong trang Hồ sơ trước khi đăng ca.',

  'admin.identity.tab': 'Xác thực',
  'admin.identity.settings.title': 'Cài đặt xác thực',
  'admin.identity.settings.requirePhone':
    'Bắt buộc xác thực SĐT trước khi ứng tuyển / đăng ca',
  'admin.identity.settings.requirePhone.hint':
    'Chỉ bật khi SMS đã gửi được thật (SpeedSMS), nếu không người dùng sẽ bị kẹt.',
  'admin.identity.settings.requireIdentity':
    'Bắt buộc CCCD đã duyệt trước khi employer đăng ca',
  'admin.identity.settings.otpCap': 'Trần số OTP / 24 giờ (toàn hệ thống)',
  'admin.identity.settings.otpStats':
  ...
  'admin.identity.empty': 'Không có hồ sơ nào.',
  'admin.identity.approve': 'Duyệt',
  'admin.identity.reject': 'Từ chối',
  'admin.identity.rejectReason': 'Lý do từ chối (người dùng sẽ thấy)',
  'admin.identity.approved': 'Đã duyệt CCCD',
