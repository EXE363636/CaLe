 ...
 *   • Nhà tuyển dụng - thu hút và giữ chân người lao động tốt, viết mô tả ca
...
const WORKER_TIPS: Tip[] = [
  {
    ...
    body:
      'Hỏi rõ yêu cầu ngay đầu ca, làm tốt phần việc được giao và giữ thái độ tích cực đến phút cuối. Một người lao động khiến nhà tuyển dụng hài lòng thường được mời lại cho các ca sau và nhận đánh giá cao - đây là cách bền vững nhất để có việc đều.',
  },
  {
...
const EMPLOYER_TIPS: Tip[] = [
  {
    title: 'Thu hút và giữ chân người lao động tốt',
    body:
      'Người lao động giỏi thường quay lại nơi đối xử công bằng. Phản hồi đơn ứng tuyển nhanh, đánh giá đúng và ghi nhận nỗ lực sẽ giúp bạn thu hút ứng viên chất lượng và giữ chân họ cho các ca sau, thay vì phải tuyển lại từ đầu mỗi lần.',
  },
  {
    title: 'Viết mô tả ca rõ ràng',
    body:
      'Ghi cụ thể công việc phải làm, địa điểm, trang phục, người liên hệ và những thứ cần mang theo. Mô tả càng rõ thì càng đúng người ứng tuyển, càng ít hiểu lầm tại chỗ và người lao động càng dễ chuẩn bị tốt trước khi đến.',
  },
  {
  ...
  },
  {
    ...
    body:
      'Duyệt ứng viên sớm, nhắc lịch trước giờ bắt đầu và mô tả đúng thực tế công việc để tránh gây bất ngờ. Khi người lao động biết rõ mình sẽ làm gì và cảm thấy được tôn trọng, tỉ lệ huỷ ca và vắng mặt sẽ giảm rõ rệt.',
  },
];
...
export default function UserGuidePage() {
  return (
    <InfoPage
      eyebrow="Cẩm nang"
      title="Cẩm nang đi ca cho người lao động và nhà tuyển dụng"
    ...
    >
      <section>
        <p>
          ...
          tốt. Người lao động giữ được uy tín và việc đều; nhà tuyển dụng tuyển
      ...
      <InfoSection title="Ghi nhớ nhanh">
        <p>
          ...
          điều tạo nên phần lớn sự khác biệt. Người lao động chủ động và đúng giờ,
