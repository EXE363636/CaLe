...
export const metadata = { title: 'Điều khoản sử dụng — CaLẻ / ShiftNow' };
...
export default function TermsPage() {
  return (
    <InfoPage
      ...
      intro="Bằng việc tạo tài khoản hoặc sử dụng dịch vụ CaLẻ / ShiftNow, bạn đồng ý với các điều khoản dưới đây. Tài liệu áp dụng cho phiên bản dùng thử của sản phẩm."
    >
