  ...
  return (
    <div className="relative isolate mx-auto flex max-w-6xl flex-col px-4 py-8 sm:px-6 lg:px-8">
      ...
      <section className="order-2 mb-8 mt-8 grid grid-cols-2 gap-4 sm:grid-cols-4 lg:order-none lg:mt-0">
        ...
        />
        {/* Thu nhập: local (ví đầy đủ) hoặc supabase (ví read-only suy từ server). */}
        {(hasCapability('wallet') || hasCapability('walletReadonly')) && (
          <StatTile
      ...
      <Modal
        open={statDetail === 'income' && (hasCapability('wallet') || hasCapability('walletReadonly'))}
        onClose={() => setStatDetail(null)}
