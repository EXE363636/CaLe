...
export const metadata = { title: 'Chính sách bảo mật — CaLẻ / ShiftNow' };
...
export default function PrivacyPage() {
  return (
    <InfoPage
      ...
      intro="Tài liệu này mô tả thông tin chúng tôi thu thập, cách dùng và cách bảo vệ. Áp dụng cho phiên bản dùng thử của CaLẻ / ShiftNow."
    >
